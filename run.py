...
# Set this flag True if you want the display in landscape mode.#!/usr/bin/python
# -*- coding: UTF-8 -*-
import os
import sys
import time
...
def play_processed_video(processed_folder, disp, fps=10.0):
    ...
    Also plays the corresponding audio (audio.mp3 in the same folder) concurrently using ffplay.
    """
